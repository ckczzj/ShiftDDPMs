...
class RegularTrainer(BaseTrainer):
    ...
    def _build_model(self):
        ...
        self.train_conditional_model = "num_class" in self.config["denoise_fn_config"].keys()
        ...
        while True:
            ...
            with torch.cuda.amp.autocast(enabled=self.enable_amp):
                ...
                output = self.gaussian_diffusion.regular_train_one_batch(
                    ...
                    condition=move_to_cuda(batch["net_input"]["condition"]) if self.train_conditional_model else None,
                )
